...
namespace sysinfo
{
    public sealed partial class MainWindow : Window
    {
        ...
        public void PopulateWeatherInfo()
        {
            ...
            if (weatherResponse.Main.Humidity != null) HumidityTb.Text = weatherResponse.Main.Humidity?.ToString()+"k/s" ;
            if (weatherResponse.Wind.Speed != null) WindTb.Text = Math.Round(Tools.MileToKm(weatherResponse.Wind.Speed.Value), 1).ToString(CultureInfo.InvariantCulture) ;
